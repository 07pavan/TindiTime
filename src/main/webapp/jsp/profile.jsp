...
<c:if test="${empty requestScope.profileVerified}">
            ...
            <div class="col-lg-9 text-start" id="profile-details-column">
                ...
                <c:if test="${not empty requestScope.success}">
                    <div class="alert alert-success px-4 py-3 small rounded-3 d-flex align-items-center gap-2 mb-4 shadow-sm" role="alert" id="profile-success-alert">
                        ...
                        <div class="fw-semibold"><c:out value="${requestScope.success}" /></div>
                    </div>
                </c:if>
                ...
                <c:if test="${not empty requestScope.error}">
                    <div class="alert alert-danger px-4 py-3 small rounded-3 d-flex align-items-center gap-2 mb-4 shadow-sm" role="alert" id="profile-error-alert">
                        ...
                        <div class="fw-semibold"><c:out value="${requestScope.error}" /></div>
                    </div>
                </c:if>
                            ...
                            <form action="${pageContext.request.contextPath}/profile" method="POST" id="profile-form">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group border rounded-3 p-1 bg-white align-items-center">
                                        ...
                                        <input type="text" name="name" class="form-control border-0 shadow-none py-1.5" value="${not empty sessionScope.username ? sessionScope.username : 'Pavan Hegade'}" required id="profile-name-field">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group border rounded-3 p-1 bg-light align-items-center">
                                        ...
                                        <input type="email" name="email" class="form-control border-0 shadow-none py-1.5 bg-light" value="${not empty sessionScope.email ? sessionScope.email : 'pavanhegade1232@gmail.com'}" required readonly id="profile-email-field">
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group border rounded-3 p-1 bg-white align-items-center">
                                        ...
                                        <input type="text" name="phone" class="form-control border-0 shadow-none py-1.5" value="${not empty sessionScope.phone ? sessionScope.phone : '+91 98765 43210'}" required id="profile-phone-field">
                                    </div>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group border rounded-3 p-1 bg-white align-items-start">
                                        ...
                                        <textarea name="address" rows="3" class="form-control border-0 shadow-none py-1.5" required id="profile-address-field"><c:out value="${not empty sessionScope.address ? sessionScope.address : 'Flat 402, Sunset Heights, Bandra West, Mumbai'}" /></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade show active" id="panel-profile-info" role="tabpanel" aria-labelledby="tab-profile">
                        <div class="card border-0 shadow-sm rounded-4 p-4" id="personal-info-card-resp">
                            ...
                            <form action="${pageContext.request.contextPath}/profile" method="POST">
                                ...
                                <div class="mb-3">
                                    <label class="form-label text-muted small fw-bold">Full Name</label>
                                    <input type="text" name="name" class="form-control rounded-3 py-2" value="${not empty sessionScope.username ? sessionScope.username : 'Pavan Hegade'}" required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-muted small fw-bold">Email Address</label>
                                    <input type="email" name="email" class="form-control rounded-3 py-2 bg-light" value="${not empty sessionScope.email ? sessionScope.email : 'pavanhegade1232@gmail.com'}" required readonly>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label text-muted small fw-bold">Mobile Number</label>
                                    <input type="text" name="phone" class="form-control rounded-3 py-2" value="${not empty sessionScope.phone ? sessionScope.phone : '+91 98765 43210'}" required>
                                </div>
                                <div class="mb-4">
