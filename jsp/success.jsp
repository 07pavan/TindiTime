                ...
                <div class="card border-0 shadow-lg p-5 rounded-4 bg-white" id="success-card">
                    ...
                    <div class="bg-light p-3 rounded-4 border text-start mb-4 fs-7" id="success-receipt-details">
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span class="fw-bold text-dark font-mono"><%= orderId %></span>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                    ...
                    <div class="d-grid gap-2" id="success-action-ctas">
                        <a href="orders" class="btn btn-orange py-3 rounded-3 fw-bold fs-6 text-decoration-none shadow-sm hover-up">
                            Track Order & Status <i class="bi bi-geo-alt ms-1"></i>
                        </a>
                        <a href="restaurants.jsp" class="btn btn-outline-orange py-2.5 rounded-3 fw-bold fs-7 text-decoration-none">
